    ...
    <div className="min-h-screen bg-[#F0EDE6]">
      <header className="bg-[#1C3D2E] px-6 py-3 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="font-['Cormorant_Garamond'] text-white text-xl tracking-wide">Temperature</span>
        </div>
        <div className="text-sm font-['JetBrains_Mono'] text-white/90">
          <span className="text-[#74C69D] font-medium">{currentTemp}°C</span> · Kathmandu
        </div>
      </header>
      ...
      <div className="flex">
        <aside className="w-56 bg-[#1C3D2E] py-6 border-r border-[#74C69D]/10 overflow-y-auto flex flex-col h-[calc(100vh-60px)]">
          <nav className="flex-1">
            ...
            <button onClick={() => navigate('/dashboard/temperature')} className="w-full flex items-center gap-3 px-5 py-2.5 text-sm text-white hover:bg-[#74C69D]/8 border-l-[3px] border-[#74C69D] transition-all">
        ...
        <main className="flex-1 overflow-y-auto px-8 py-6">
          <div className="mb-6">
            <h1 className="font-['Cormorant_Garamond'] text-3xl font-semibold text-[#1C3D2E]">Temperature Monitoring</h1>
          ...
          <div className="bg-white border border-[#DDD9D2] rounded-xl p-6 shadow-sm mb-6">
            <div className="grid grid-cols-4 gap-6">
              <div>
                ...
                <div className="font-['Cormorant_Garamond'] text-5xl text-[#1C3D2E]">{currentTemp}°</div>
              </div>
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">24H Range</div>
                <div className="text-[#1C3D2E] font-medium">{minTemp}° — {maxTemp}°</div>
              </div>
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">Optimal</div>
                <div className="text-[#2D6A4F] font-medium">{optimalMin}° — {optimalMax}°</div>
              </div>
              <div>
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              ...
              <div className="text-[#1C3D2E] text-sm">Temperature within optimal range for growing conditions</div>
            </div>
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-3">Trend</div>
              <div className="text-[#2D6A4F] text-sm font-medium">Stable</div>
            </div>
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-3">Action</div>
              <button className="text-[#2D6A4F] text-sm font-medium hover:text-[#1C3D2E] transition-colors">Continue monitoring</button>
            </div>
          </div>
        </main>
      </div>
