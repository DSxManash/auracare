    ...
    <div className="min-h-screen bg-[#F0EDE6]">
      <header className="bg-[#1C3D2E] px-6 py-3 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="font-['Cormorant_Garamond'] text-white text-xl tracking-wide">Nutrients</span>
        </div>
        <div className="text-sm font-['JetBrains_Mono'] text-white/90">
          <span className="text-[#74C69D] font-medium">NPK 10:10:10</span> · Good
        </div>
      </header>
      ...
      <div className="flex">
        <aside className="w-56 bg-[#1C3D2E] py-6 border-r border-[#74C69D]/10 overflow-y-auto flex flex-col h-[calc(100vh-60px)]">
          <nav className="flex-1">
            ...
            <button onClick={() => navigate('/dashboard/light-intensity')} className="w-full flex items-center gap-3 px-5 py-2.5 text-sm text-white/50 hover:text-white hover:bg-[#74C69D]/8 border-l-[3px] border-transparent hover:border-[#74C69D] transition-all">
              <span className="w-5">L</span> Light
            </button>
            <button onClick={() => navigate('/dashboard/nutrients')} className="w-full flex items-center gap-3 px-5 py-2.5 text-sm text-white hover:bg-[#74C69D]/8 border-l-[3px] border-[#74C69D] transition-all">
        ...
        <main className="flex-1 overflow-y-auto px-8 py-6">
          <div className="mb-6">
            <h1 className="font-['Cormorant_Garamond'] text-3xl font-semibold text-[#1C3D2E]">Nutrient Levels</h1>
            <div className="text-sm text-[#8A9BA3] mt-2 font-['JetBrains_Mono'] tracking-wide">Main Greenhouse · Last tested today</div>
          </div>

          <div className="bg-white border border-[#DDD9D2] rounded-xl p-6 shadow-sm mb-6">
            <div className="grid grid-cols-4 gap-6">
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">NPK Ratio</div>
                <div className="font-['Cormorant_Garamond'] text-4xl text-[#1C3D2E]">10:10:10</div>
              </div>
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">Total</div>
                <div className="text-[#1C3D2E] font-medium">305 ppm</div>
              </div>
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">Status</div>
                <div className="text-[#2D6A4F] font-medium">Balanced</div>
              </div>
              <div>
                <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-2">Next Feed</div>
                <div className="flex items-center gap-2"><span className="w-2 h-2 bg-[#2D6A4F] rounded-full"></span><span className="text-[#2D6A4F] font-medium">In 14 days</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              ...
              <div className="text-[#1C3D2E] text-sm">Nutrient levels balanced and optimal for growth</div>
            </div>
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-3">Rate</div>
              <div className="text-[#2D6A4F] text-sm font-medium">Normal depletion rate</div>
            </div>
            <div className="bg-white border border-[#DDD9D2] rounded-xl p-5 shadow-sm">
              <div className="text-sm text-[#8A9BA3] font-['JetBrains_Mono'] uppercase tracking-wide mb-3">Action</div>
              <button className="text-[#2D6A4F] text-sm font-medium hover:text-[#1C3D2E] transition-colors">Schedule feeding</button>
            </div>
          </div>
        </main>
      </div>
